...
alter table t_user_vehicle_relatived add INDEX userid_sysdict (userid);
alter table t_user_vehicle_relatived add INDEX vin_relative (vin);
alter table t_user_vehicle_relatived add INDEX vin_iflag (vin,iflag);
