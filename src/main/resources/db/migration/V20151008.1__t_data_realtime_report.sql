CREATE TABLE IF NOT EXISTS t_data_realtime_report (
  ...
  left_front_window_information varchar(1) NOT NULL COMMENT '左前车窗信息 0关1开2中间3无效',
  left_rear_window_information varchar(1) NOT NULL COMMENT '左后车窗信息 0关1开2中间3无效',
  right_front_window_information varchar(1) NOT NULL COMMENT '右前车窗信息 0关1开2中间3无效',
  right_rear_window_information varchar(1) NOT NULL COMMENT '右后车窗信息 0关1开2中间3无效',
  vehicle_temperature smallint(6) NOT NULL COMMENT '车内温度',
  vehicle_outer_temperature smallint(6) NOT NULL COMMENT '车外温度',
  left_front_door_information varchar(1) NOT NULL COMMENT '左前车门信息 0关1开2保留3无效',
  left_rear_door_information varchar(1) NOT NULL COMMENT '左后车门信息 0关1开2保留3无效',
  right_front_door_information varchar(1) NOT NULL COMMENT '右前车门信息 0关1开2保留3无效',
  right_rear_door_information varchar(1) NOT NULL COMMENT '右后车门信息 0关1开2保留3无效',
